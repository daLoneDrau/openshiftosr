...
import com.osrapi.repositories.TreasureTableRepository;
...
public final class TreasureTableController {
	 ...
	 * @return {@link Object}
	 */
	@RequestMapping(path = "/treasure_table", method = RequestMethod.GET)
	 ...
	 * @return {@link Object}
	 */
	@RequestMapping(path = "/treasure_table/roll", method = RequestMethod.GET)

...
import com.osrapi.repositories.dwarfstar.barbarianprince.HexRoadRepository;
...
public final class HexRoadController {
	 ...
	 * @return {@link Object}
	 */
	@RequestMapping(path = "/barbarian_prince/roads",
	 ...
	 * @return {@link Object}
	 */
	@RequestMapping(path = "/barbarian_prince/roads/{id}",
			method = RequestMethod.GET)

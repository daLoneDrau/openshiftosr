...
import com.osrapi.repositories.dwarfstar.barbarianprince.TravelEventRepository;
...
public final class TravelEventController {
	 ...
	 * @return {@link Object}
	 */
	@RequestMapping(path = "/barbarian_prince/travel_events",
	 ...
	 * @return {@link Object}
	 */
	@RequestMapping(path = "/barbarian_prince/travel_events/{id}",
			method = RequestMethod.GET)
	 ...
	 * @return {@link Object}
	 */
	@RequestMapping(path = "/barbarian_prince/travel_events/by_roll",
			method = RequestMethod.GET)

...
import com.osrapi.repositories.dwarfstar.barbarianprince.HexRiverCrossingRepository;
...
public final class HexRiverCrossingController {
	 ...
	 * @return {@link Object}
	 */
	@RequestMapping(path = "/barbarian_prince/river_crossings",
	 ...
	 * @return {@link Object}
	 */
	@RequestMapping(path = "/barbarian_prince/river_crossings/{id}",
			method = RequestMethod.GET)
	 ...
	 * @return {@link Object}
	 */
	@RequestMapping(path = "/barbarian_prince/river_crossings/to_from",
			method = RequestMethod.GET)
